...
namespace PJATK_APBD_Cw7_s33133.Migrations
{
    ...
    [Migration("20260519200347_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33133.Models.Component", b =>
                {
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33133.Models.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33133.Models.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33133.Models.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33133.Models.PCComponent", b =>
                {
                    b.Property<int>("PCId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33133.Models.Component", b =>
                {
                    b.HasOne("PJATK_APBD_Cw7_s33133.Models.ComponentManufacturer", "Manufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PJATK_APBD_Cw7_s33133.Models.ComponentType", "Type")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("PJATK_APBD_Cw7_s33133.Models.PCComponent", b =>
                {
                    b.HasOne("PJATK_APBD_Cw7_s33133.Models.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PJATK_APBD_Cw7_s33133.Models.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
