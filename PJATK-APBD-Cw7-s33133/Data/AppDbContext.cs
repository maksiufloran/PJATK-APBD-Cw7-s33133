...
namespace PJATK_APBD_Cw7_s33133.Data;
...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Seedowanie danych (minimum 3 rekordy dla każdej tabeli)
        ...
        modelBuilder.Entity<PC>().HasData(
            ...
            new PC { Id = 3, Name = "Home Standard", Weight = 8.0f, Warranty = 24, CreatedAt = new DateTime(2026, 1, 10, 10, 0, 0), Stock = 20 }
        );
